;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    pt: {
                        ...
                        noEventForToday: "Nenhum paciente agendado para hoje.",
                        noEventForThisDay: "Nenhum paciente agendado para este dia.",
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        // markup += '<div class="edit-btn" onclick="atualizarPaciente()"></div>';
        markup += '<div class="event-icon"><div class="event-bullet-'+event_data.type+'"';
        if (event_data.color) {
            markup += 'style="background-color:'+event_data.color+'"'
        }
        markup += '></div></div><div class="event-info"><p class="event-title">'+_.limitTitle(event_data.cliente);
        if (event_data.hora) markup += '<span>'+event_data.hora+'</span>';
        markup += '</p>'
        // if (event_data.atendente) markup += '<p class="event-desc">'+event_data.atendente+'</p>';
